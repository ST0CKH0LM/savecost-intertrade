...
export const categoryLabels: Record<ProductCategory, string> = {
  Chemical: "เคมีภัณฑ์",
  Grease: "จาระบี",
  "Industrial Sprays": "ส⁠เปรย์อุตสาหกรรม",
...
export const catalogProducts: CatalogProduct[] = [
  {
    ...
    category: "Chemical",
    description: "น้ำยาป้องกันตะกรันและสนิมในระบบคู⁠ล⁠ลิ่ง⁠ทาวเวอร์ ช่วยปรับค่า pH และปลอดภัยกับโลหะ พลาสติก ซีล และวาล์ว",
  },
  {
    id: "SC-1002",
    name: "Biocide",
  ...
  },
  {
    ...
    name: "Scale remove",
    category: "Chemical",
    description: "น้ำยาล้างตะกรันและสนิมในระบบน้ำ ช่วยละลายตะกรันในคู⁠ล⁠ลิ่ง⁠ทาวเวอร์โดยไม่ทำอันตรายต่อพื้นผิว",
  },
  {
    id: "SC-1005",
  ...
  },
  {
    ...
    category: "Chemical",
    description: "น้ำยาเข้มข้นสำหรับทำความสะอาดฟิน⁠คอยล์เย็นและแผ่นกรอง ขจัดสิ่งสกปรกโดยไม่ทำลายอลู⁠มิ⁠เนียม",
  },
  {
    id: "SC-1007",
  ...
  },
  {
    ...
    name: "Scale inhibitor",
    category: "Chemical",
    description: "น้ำยาป้องกันตะกรัน สนิม และการกัดกร่อนในระบบบอย⁠เลอ⁠ร์และท่อไอน้ำ ใช้งานสะดวกและประหยัด",
  },
  {
    id: "SC-1011",
    name: "Rust Remover",
  ...
  },
  {
    ...
    category: "Grease",
    description: "จาระบีอเนกประสงค์ ให้การหล่อลื่นดี ป้องกันน้ำ และเหมาะสำหรับงานหล่อลื่นทั่วไปในหลายช่วงอุณหภูมิ",
  },
  {
    id: "SC-2002",
    name: "Anti sieze grease",
    category: "Grease",
    description: "จาระบีสีทองผสมสารท⁠อง⁠แดง ป้องกันการจับตายของโลหะกับโลหะ และทนความร้อนได้สูงถึง 1,450 องศาเซลเซียส",
  },
  {
    id: "SC-2003",
    name: "Synthetic grease",
    category: "Grease",
    description: "จาระบีสังเคราะห์เกรดพิเศษ เหมาะสำหรับงานหนักและลูกปืนที่ทำงานในอุณหภูมิสูงอย่างต่อเนื่อง",
  },
  {
    id: "SC-2004",
    name: "Lithium complex grease",
    category: "Grease",
    description: "จาระบีลิ⁠เธี⁠ยมคอมเพล็กซ์ จุดหลอมตัวสูง รับแรงกระแทกได้ดี ป้องกันน้ำ สนิม และการกัดกร่อนของโลหะ",
  },
  {
    id: "SC-3001",
  ...
  },
  {
    ...
    category: "Industrial Sprays",
    description: "ส⁠เปรย์หล่อลื่นแม่พิมพ์สำหรับงานถอดแบบหรือชิ้นพลาสติก ช่วยให้ถอดชิ้นงานง่ายและรวดเร็ว",
  },
  {
    id: "SC-3005",
    name: "Mold cleaner",
    category: "Industrial Sprays",
    description: "ส⁠เปรย์ทำความสะอาดคราบน้ำมัน ไขมัน และยางเหนียวของโมลด์หรือแม่พิมพ์ได้อย่างรวดเร็ว",
  },
  {
    id: "SC-3006",
    name: "Moly dry",
  ...
  },
  {
    ...
    category: "Industrial Sprays",
    description: "ส⁠เปรย์ป้องกันการลื่นไหลของสายพาน ลดเสียงดัง ใช้ได้กับสายพานทุกประเภท และช่วยยืดอายุการใช้งาน",
  },
  {
    id: "SC-3008",
    name: "Red insulating varnish",
    category: "Industrial Sprays",
    description: "ส⁠เปรย์เคลือบลวดมอเตอร์เพื่อป้องกันความร้อน ใช้งานง่าย แห้งเร็ว และไม่ต้องผ่านการอบแห้ง",
  },
  {
    id: "SC-3009",
    name: "Electric motor cleaner",
    category: "Industrial Sprays",
    description: "ส⁠เปรย์ฉีดล้างมอเตอร์ ไม่เป็นสื่อนำไฟฟ้า ไม่ทำปฏิกิริยากับพลาสติก และไม่ติดไฟ",
  },
  {
    id: "SC-3010",
    name: "Food grade silicone",
    category: "Industrial Sprays",
    description: "ส⁠เปรย์ฉีดแม่พิมพ์สำหรับหล่อลื่นและรักษาแม่พิมพ์ เหมาะสำหรับโรงงานอุตสาหกรรมผลิตอาหาร",
  },
  {
    id: "SC-3011",
  ...
  },
  {
    ...
    category: "Industrial Water Filters",
    description: "สารกรองน้ำเร⁠ซิ่นสำหรับกำจัดความกระด้าง หินปูน แคลเซียม แมกนีเซียม และดูดซับสี เหมาะสำหรับการทำน้ำอ่อน",
  },
  {
    id: "SC-5003",
